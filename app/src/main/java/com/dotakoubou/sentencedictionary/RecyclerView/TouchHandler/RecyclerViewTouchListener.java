...
public class RecyclerViewTouchListener implements RecyclerView.OnItemTouchListener{
    ...
    public RecyclerViewTouchListener(Context context,
        ...
        gestureDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onDoubleTap(MotionEvent e) {
                View child = recyclerView.findChildViewUnder(e.getX(), e.getY());
                if (child != null && clickListener != null) {
                    clickListener.onDoubleClick(child, recyclerView.getChildPosition(child));
                }
                return  true;
            }
            ...
            public boolean onSingleTapConfirmed(MotionEvent e) {
                View child = recyclerView.findChildViewUnder(e.getX(), e.getY());
                if (child != null && clickListener != null) {
                    clickListener.onSingleClick(child, recyclerView.getChildPosition(child));
                }
                return true;
            }
        });
    ...
    public boolean onInterceptTouchEvent(RecyclerView rv, MotionEvent e) {
        ...
        if (clickListener != null && gestureDetector.onTouchEvent(e)) {
            ...
            else //if cannot find child -> clicked outside of views -> clear selection
               clickListener.clearSelection();
        }
        return false;
    }
